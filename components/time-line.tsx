        ...
        <div className="w-full max-w-3xl mx-auto md:pb-40 md:pt-20">
            <div className="-my-6">
                {dataAboutPage.map((data) => (
                    ...
                    relative py-6 pl-8 sm:pl-32 group
                    ">
                        ...
                        <div className="flex flex-col sm:flex-row items-start mb-1 
                                        ...
                                        after:translate-y-1.5">
                                            <time className="sm:absolute left-0 translate-y-0.5 inline-flex 
                                            items-center justify-center text-xs font-semibold uppercase 
                                            w-30 h-6 mb-3 sm:mb-0 text-emerald-600 bg-emerald-100 rounded-lg">{data.date}</time>
                            <p className="text-xl font-bold text-gray-400">
                            {data.subtitle}
                            </p>  
                            <p className="text-slate-400 max-w-md block"> {data.description}</p>              
                        </div>
                    </div>
                ))}
            </div>
